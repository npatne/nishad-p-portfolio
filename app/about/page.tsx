...
const educationData: EducationItem[] = [
  ...
  },
  {
    ...
    period: "2016 - 2020",
    description:
      "Studied electronics engineering with a focus on digital systems, statistics, and computer architecture.",
  },
];
...
const testimonialData: TestimonialItem[] = [
  {
    quote:
      "I've worked closely with Nishad and can confidently say he's an exceptional product specialist. His contributions significantly improved the Writing Analytics Tool (WAT) user experience, through rigorous testing, usability assessments, and style guide implementation. Nishad's technical skills, work ethic, and reliability make him highly recommendable.",
    name: "Zeinab Serhan",
    title: "Sr. Software Engineer, LEI, ASU",
  },
  {
    quote:
      "Nishad's exceptional performance as both a student and grader sets him apart. In my UX course, his talent emerged in user-centric research and data-driven design. As a grader, he demonstrated dedication, offering valuable feedback to fellow students, fostering their growth and in integral part of the journey through the course.",
    name: "Deborah Prewitt",
    title: "MS in UX Program Chair, ASU",
  },
  {
    quote:
      "Nishad's exceptional commitment, proactivity, and ability to handle multiple tasks within deadlines make him a valuable asset. His seamless collaboration and problem-solving skills translate functional needs into technical solutions effortlessly.",
    name: "Neha Srivastava",
    title: "Consultant, C&M, Deloitte",
  },
  {
    quote:
      "Nishad has excellent UI developer skills. He has a very good attitude towards approaching a problem statement and taking it to completion. Nishad worked with me for 6 months and would like to have him again in my team.",
    name: "Vaibhav Goel",
...
export default function AboutPage() {
  return (
    <div className="min-h-screen py-12 px-6 md:px-10 md:max-w-5xl 	lg:max-w-7xl">
      <header className="mb-12 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="md:w-2/3">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mb-6">
            UX Designer and Engineer with over 4 years of experience creating
            and managing large-scale applications across multiple technologies.
          </p>
          <Button asChild>
            <a
        ...
        <div className="md:w-1/3 w-full">
          <img
            src="https://4kpakrtcc8hsoxno.public.blob.vercel-storage.com/nishad%20profile.jpg"
            alt="Nishad Patne"
      ...
      {/* Informal blurb section */}
      <div className="mb-12 flex flex-col md:flex-row items-center gap-6 bg-muted/30 p-6 rounded-lg border border-border">
        {/* Text */}
        <div>
          <h2 className="text-2xl font-semibold mb-3">The Other Side of Me</h2>
          <p className="text-muted-foreground mb-4">
            Hi there—this is my clean, elegant portfolio. I experimented with a
            much more colorful site before settling on this look.
            <br /> Design’s a balancing act, and I’m still figuring out the
            right mix of flair and simplicity.
            <br />
            <br /> Want to see that side? Check out my old portfolio.
          </p>
          <Button variant="outline" asChild>
            <a
              href="https://nishadpatne.framer.website"
              target="_blank"
              rel="noopener noreferrer"
            >
              Visit My Framer Site
            </a>
          </Button>
        </div>
      </div>
