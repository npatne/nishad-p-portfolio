...
const starterQuestions: Record<string, string[]> = {
  "/": [ // general mode
    ...
    "Tell me about projects and type pf work nishad has on this protfolio?",
    "What technologies dis Nishad work with?",
  ],
  "/projects": [ // specific mode 
    "Summarize the key features of this project in 250 words.",
    "What was Nishad's role in these project.",
  ...
  "/blog": [ // specic mode
    ...
    "Can you summarize your this post?",
  ],
}
...
export default function Chatbot() {
  ...
  const messagesEndRef = useRef<HTMLDivElement>(null) // Keep this ref for the anchor div
  const messagesContainerRef = useRef<HTMLDivElement>(null) // Add ref for the scrollable container
  ...
  useEffect(() => {
    // messagesEndRef.current?.scrollIntoView({ behavior: "smooth" }) // Remove this line
    // Instead, scroll the container manually
        ...
        { !state.isCollapsed && (
          <>
            ...
            <div ref={messagesContainerRef} className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {/* Scroll anchor - Keep this div, even if not directly used by scrollIntoView, it helps ensure the last message is fully rendered before scrolling */}
